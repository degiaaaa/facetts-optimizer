...
srun conda run -p /mnt/qb/work2/butz1/bst080/miniconda3/envs/label_env python /mnt/qb/work/butz/bst080/faceGANtts/data/lrs2_preprocessing/lrs2_split/filelist_split.py
