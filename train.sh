...
#SBATCH --output=train_gan_freeze5_warmup2_lr4_micro16_den0_adv01%j.out #gan_den_lr6_adv01_warmup10
#SBATCH --error=train_gan_freeze5_warmup2_lr4_micro16_den0_adv01%j.err
